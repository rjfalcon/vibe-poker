...
from app.schemas.hand import BulkImportOut, SessionOut
...
@router.post("/import", response_model=BulkImportOut, status_code=status.HTTP_201_CREATED)
async def import_files(
    ...
    return BulkImportOut(
        ...
        sessions=[SessionOut.model_validate(s) for s in sessions_out],
    )
